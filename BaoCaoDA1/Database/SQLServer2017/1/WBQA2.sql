...
create table DON_HANG (
   ...
   TRANG_THAI_DH        nvarchar(255)        null,
   NGAY_TAO_DH          datetime             null,
...
create table NGUOI_DUNG (
   ...
   VAI_TRO_ND           nvarchar(255)        null,
   NGAY_TAO_ND          datetime             null,
...
create table THANH_TOAN (
   ...
   TRANG_THAI_TT        nvarchar(255)        null,
   NGAY_TT              datetime             null,
